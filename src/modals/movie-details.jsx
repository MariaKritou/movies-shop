            ...
            <div class="modal-dialog">
                <div className="modal-content bg-dark text-white">
                    ...
                    <div class="modal-body">
                        <img alt='movie' className="img-width" src={ctx.movieDetails.backdrop_path === null ? window.location.origin + '/default.png' : `https://image.tmdb.org/t/p/w500/${ctx.movieDetails.backdrop_path}`} />
                    </div>
